export default {
  ...
  greaterThan: (target, comperator) =>  {
    return `The ${target} cannot be greater than ${comperator}.`;
  },
  lessThan: (target, comperator) => {
    return `The ${target} cannot be less than ${comperator}.`;
  },
}